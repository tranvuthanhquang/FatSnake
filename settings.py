# Dimensions
WIDTH = 1024  # Width of game surface
HEIGHT = 1024  # Height of game surface
ROWS = 17
SQUARE_SIZE = WIDTH // ROWS
GAP_SIZE = 2  # Gap between adjacent squares

# Colors
SURFACE_CLR = (255, 204, 229)
GRID_CLR = (255, 255, 255)
SNAKE_CLR = (255, 153, 255)
APPLE_CLR = (255, 255, 0)
HEAD_CLR = (204, 153, 255)
...
SNAKE_MAX_LENGTH = (
    ROWS * ROWS - INITIAL_SNAKE_LENGTH
